                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php if( $value1["status"] == 3 ){ ?>Sim<?php }else{ ?>Não<?php } ?></td>
                        <td>
                          ...
                          <a href="/admin/users/<?php echo htmlspecialchars( $value1["id_user"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" class="btn btn-default btn-xs"><i class="fa fa-unlock"></i> Alterar Senha</a>
