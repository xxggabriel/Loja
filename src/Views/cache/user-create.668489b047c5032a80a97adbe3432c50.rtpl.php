                ...
                <form role="form" action="/admin/users/create" method="post">
                  <div class="box-body">
                    ...
                    <div class="radio-inline">
                        <label class="radio-inline"><input type="radio" value="2" name="status" checked>Usuario Padrão</label>
                        <label class="radio-inline"><input type="radio" value="3" name="status">Acesso de Administrador</label>
                    </div>
                  </div>
                  <!-- /.box-body -->
