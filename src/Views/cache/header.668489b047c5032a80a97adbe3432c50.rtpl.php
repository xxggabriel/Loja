...
<head>
  ...
  <link rel="stylesheet" href="/resource/admin/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/resource/admin/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="/resource/admin/bower_components/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  ...
  <!--[if lt IE 9]>
  <script src="/resource/admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="/resource/admin/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <a href="/resource/admin/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <!-- Menu toggle button -->
            <a href="/resource/admin/#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="/resource/admin/#">See All Messages</a></li>
            </ul>
          </li>
          <!-- /.messages-menu -->
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="/resource/admin/#">View all</a></li>
            </ul>
          </li>
          <!-- Tasks Menu -->
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="/resource/admin/#">View all tasks</a>
              </li>
            </ul>
          </li>
          <!-- User Account Menu -->
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="/resource/admin/#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="/resource/admin/#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="/resource/admin/#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
          ...
          <li>
            <a href="/resource/admin/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
